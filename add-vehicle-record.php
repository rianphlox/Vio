          ...
          <div class="col-md-12">
            <div class="card card-user">
              <div class="card-header">
                ...
                <h5 class="text-sm text-center">Vehicle Service Card</h5>
              </div>
              <div class="card-body">
                <form method="post" id="addVehicleRecord">
                  <div class="row">
                    <div class="col-md-12 pr-1">
                    <div class="form-group">
                        <label>Vehicle Identification Number</label>
                        <input type="text" placeholder="Identification Number" class="form-control" name="vin">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="" class="form-control" name="vehicle_type">
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="vehicle_chassis_no" id="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="location" id="zcx" class="form-control">
                      </div>
                    </div>
...
<script>
    const form = document.querySelector('#addVehicleRecord')
